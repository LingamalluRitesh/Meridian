"""
ModelForge AI Deep Time Series Forecasting - Engine 14
...
class DilatedTemporalConvolutionBlock_14:
...
class DeepTemporalForecastingEngine_14:
    def __init__(self, sequence_length: int = 64, horizon: int = 12, channels: int = 32):
        ...
        self.dilated_blocks = [
            DilatedTemporalConvolutionBlock_14(channels, dilation_rate=2**i) for i in range(4)
        ]
